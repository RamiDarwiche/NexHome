        ...
        <SheetDescription className="flex flex-col">
          ...
          <div className="container px-0 flex-1 justify-end">
            {isAuthenticated ? (
              ...
              <Button
                className="flex-1 bg-white dark:bg-primary-sdlight2 dark:text-white shadow-primary-uilight3 text-primary-sdlight1 my-4 hover:text-white hover:bg-primary-bdlight3 shadow border border-primary-uilight3 select-none"
